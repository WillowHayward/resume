...
\name{William}{Hayward}
\address{56 Armadale Street, St Lucia 4067, Brisbane, QLD}
\mobile{(+61) 04-3525-1674}

\email{HaywardWilliam1996@gmail.com}
\homepage{williamhayward.github.io}
\github{WilliamHayward}
\linkedin{williamhayward1996}
\stackoverflow{7939190}{William Hayward}

\position{Software Developer{\enskip\cdotp\enskip}Security Expert} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{}{William Hayward~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
