...
\email{WillHayCode@gmail.com}
\homepage{willhaycode.com}
\github{WillHayCode}
...
\makecvfooter{}{\thepage\ of \pageref{LastPage}}{} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
